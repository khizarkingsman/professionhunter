    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold font-headline">
            {t('welcome')}, {worker.name} ({worker.username})
          </h1>
      ...
      <Tabs defaultValue="profile">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm pt-4">
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                  <UserIcon className="text-primary" /> <strong>{t('age')}:</strong> {worker.age}
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="reviews" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle>{t('yourReviews')}</CardTitle>
              <CardDescription>{t('seeWhatCustomersSay')}</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="chats" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle>{t('yourConversations')}</CardTitle>
              <CardDescription>
                {t('whatsappOpen')}
              </CardDescription>
            </CardHeader>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          ...
                          >
                            <WhatsAppIcon />
                            <span className="ml-2 hidden sm:inline">{t('whatsApp')}</span>
                          </a>
                        </Button>
                      </div>
                    </div>
