...
const getWorkerProfileRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetWorkerProfile', inputVars);
}
getWorkerProfileRef.operationName = 'GetWorkerProfile';
exports.getWorkerProfileRef = getWorkerProfileRef;

exports.getWorkerProfile = function getWorkerProfile(dcOrVars, vars) {
